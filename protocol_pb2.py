...
_DATA_METADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='maxPostsAtOnce', full_name='Data.MetaData.maxPostsAtOnce', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='maxPostSize', full_name='Data.MetaData.maxPostSize', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='maxRequestSize', full_name='Data.MetaData.maxRequestSize', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='requestPOW', full_name='Data.MetaData.requestPOW', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='serverAddress', full_name='Data.MetaData.serverAddress', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='Data.MetaData.version', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='versionIncompatibility', full_name='Data.MetaData.versionIncompatibility', index=6,
